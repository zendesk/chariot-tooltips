  ...
  constructor(config, name, delegate) {
    ...
    if (configType === '[object Array]') {
      ...
      config = Object.assign({
        ...
        scrollAnimationDuration: DEFAULT_SCROLL_ANIMATION_DURATION
      }, config);

      this.animateTooltips = config.animateTooltips;
      this.animateScrolling = config.animateScrolling;
      this.scrollAnimationDuration = config.scrollAnimationDuration;
