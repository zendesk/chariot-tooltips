...
class NavigationHandler {
  ...
  setup() {
    ...
    const handlerFn = () => this.tutorial.end(true);

    // get custom eventHandler for each event
    let hashChangeFn = this.delegate.handleHashChange || handlerFn;
    let popStateFn = this.delegate.handlePopState || handlerFn;
    let pushStateFn = this.delegate.handlePushState || handlerFn;
    let replaceStateFn = this.delegate.handleReplaceState || handlerFn;
